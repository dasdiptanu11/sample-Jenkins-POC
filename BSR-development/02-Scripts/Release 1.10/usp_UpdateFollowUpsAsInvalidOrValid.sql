...
/****** Object:  StoredProcedure [dbo].[usp_UpdateFollowUpsAsInvalidOrValid]    Script Date: 06/17/2016 09:48:23 ******/
...
BEGIN
	...
	(
	  ...
	  and fuval = 3
	  -- new condition (if Operation is passed as parameter 08/06/2016)
	  and (@pOpId is null or po.OpId = @pOpId)
	)     
	...
	where  FUVal not in (2, 3) 
		   ...
		   -- new condition (if Operation is passed as parameter 08/06/2016)
		   and (@pOpId is null or OperationId = @pOpId);
