...
/****** Object:  UserDefinedFunction [dbo].[ufn_FollowUp_WorkList]    Script Date: 03/02/2016 10:10:41 ******/
...
BEGIN
		...
		where 
		   coalesce(FUVal, 0) in (0,1,5) -- New rule "5 - Auto Complete" is added on 2/03/2016
