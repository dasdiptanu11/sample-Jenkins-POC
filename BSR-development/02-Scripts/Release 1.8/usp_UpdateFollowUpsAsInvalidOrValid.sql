...
/****** Object:  StoredProcedure [dbo].[usp_UpdateFollowUpsAsInvalidOrValid]    Script Date: 03/07/2016 15:53:55 ******/
...
BEGIN
  ...
  -- Latest Operation
	...
	select op2.patientid, op2.Opdate,op2.opid from op1 
	...
	update tbl_followup
	set fuval=0 ,LastUpdatedBy = 'CIDMU_SP', LastUpdatedDateTime = GETDATE() 
