...
namespace App.Business
{
    ...
    public partial class BusinessEntities : DbContext
    {
        ...
        public DbSet<tbl_Complications> tbl_Complications { get; set; }
        public DbSet<tbl_Device> tbl_Device { get; set; }
        public DbSet<tbl_DeviceBrand> tbl_DeviceBrand { get; set; }
        public DbSet<tbl_FollowUp> tbl_FollowUp { get; set; }
        public DbSet<tbl_HistoryEmail> tbl_HistoryEmail { get; set; }
        public DbSet<tbl_HistoryExtract> tbl_HistoryExtract { get; set; }
        public DbSet<tbl_HistoryLogin> tbl_HistoryLogin { get; set; }
        public DbSet<tbl_IgnorePatients> tbl_IgnorePatients { get; set; }
        public DbSet<tbl_PatientComplications> tbl_PatientComplications { get; set; }
        public DbSet<tbl_PatientOperation> tbl_PatientOperation { get; set; }
        public DbSet<tbl_PatientOperationDeviceDtls> tbl_PatientOperationDeviceDtls { get; set; }
        public DbSet<tbl_Site> tbl_Site { get; set; }
        public DbSet<tbl_URN> tbl_URN { get; set; }
        public DbSet<tbl_User> tbl_User { get; set; }
        public DbSet<tlkp_AboriginalStatus> tlkp_AboriginalStatus { get; set; }
        public DbSet<tlkp_AttemptedCalls> tlkp_AttemptedCalls { get; set; }
        public DbSet<tlkp_BandType> tlkp_BandType { get; set; }
        public DbSet<tlkp_CauseOfDeath> tlkp_CauseOfDeath { get; set; }
        public DbSet<tlkp_Complications> tlkp_Complications { get; set; }
        public DbSet<tlkp_Country> tlkp_Country { get; set; }
        public DbSet<tlkp_DeviceManufacturer> tlkp_DeviceManufacturer { get; set; }
        public DbSet<tlkp_DeviceType> tlkp_DeviceType { get; set; }
        public DbSet<tlkp_DiabetesStatus> tlkp_DiabetesStatus { get; set; }
        public DbSet<tlkp_DiabetesTreatment> tlkp_DiabetesTreatment { get; set; }
        public DbSet<tlkp_FollowUp_FUVal> tlkp_FollowUp_FUVal { get; set; }
        public DbSet<tlkp_FollowUpPeriod> tlkp_FollowUpPeriod { get; set; }
        public DbSet<tlkp_Gender> tlkp_Gender { get; set; }
        public DbSet<tlkp_HealthStatus> tlkp_HealthStatus { get; set; }
        public DbSet<tlkp_IndigenousStatus> tlkp_IndigenousStatus { get; set; }
        public DbSet<tlkp_OperationStatus> tlkp_OperationStatus { get; set; }
        public DbSet<tlkp_OperationType> tlkp_OperationType { get; set; }
        public DbSet<tlkp_OptOffStatus> tlkp_OptOffStatus { get; set; }
        public DbSet<tlkp_OptOutReason> tlkp_OptOutReason { get; set; }
        public DbSet<tlkp_PatientGroup> tlkp_PatientGroup { get; set; }
        public DbSet<tlkp_PortFixationMethod> tlkp_PortFixationMethod { get; set; }
        public DbSet<tlkp_Procedure> tlkp_Procedure { get; set; }
        public DbSet<tlkp_ReasonPort> tlkp_ReasonPort { get; set; }
        public DbSet<tlkp_ReasonSlip> tlkp_ReasonSlip { get; set; }
        public DbSet<tlkp_SecurityQuestions> tlkp_SecurityQuestions { get; set; }
        public DbSet<tlkp_SentinelEvent> tlkp_SentinelEvent { get; set; }
        public DbSet<tlkp_SiteStatus> tlkp_SiteStatus { get; set; }
        public DbSet<tlkp_SiteType> tlkp_SiteType { get; set; }
        public DbSet<tlkp_State> tlkp_State { get; set; }
        public DbSet<tlkp_Title> tlkp_Title { get; set; }
        public DbSet<tlkp_YesNo> tlkp_YesNo { get; set; }
        public DbSet<tlkp_YesNoNotknownNotStated> tlkp_YesNoNotknownNotStated { get; set; }
        public DbSet<tlkp_YesNoNotknownRecorded> tlkp_YesNoNotknownRecorded { get; set; }
        public DbSet<tlkp_YesNoNotStated> tlkp_YesNoNotStated { get; set; }
        public DbSet<tbl_Complications_Audit> tbl_Complications_Audit { get; set; }
        public DbSet<tbl_Device_Audit> tbl_Device_Audit { get; set; }
        public DbSet<tbl_DeviceBrand_Audit> tbl_DeviceBrand_Audit { get; set; }
        public DbSet<tbl_FollowUp_Audit> tbl_FollowUp_Audit { get; set; }
        public DbSet<tbl_HistoryEmail_Audit> tbl_HistoryEmail_Audit { get; set; }
        public DbSet<tbl_HistoryExtract_Audit> tbl_HistoryExtract_Audit { get; set; }
        public DbSet<tbl_HistoryLogin_Audit> tbl_HistoryLogin_Audit { get; set; }
        public DbSet<tbl_IgnorePatients_Audit> tbl_IgnorePatients_Audit { get; set; }
        public DbSet<tbl_MonitorFollowUp> tbl_MonitorFollowUp { get; set; }
        public DbSet<tbl_PatientComplications_Audit> tbl_PatientComplications_Audit { get; set; }
        public DbSet<tbl_PatientOperation_Audit> tbl_PatientOperation_Audit { get; set; }
        public DbSet<tbl_PatientOperationDeviceDtls_Audit> tbl_PatientOperationDeviceDtls_Audit { get; set; }
        public DbSet<tbl_Site_Audit> tbl_Site_Audit { get; set; }
        public DbSet<tbl_URN_Audit> tbl_URN_Audit { get; set; }
        public DbSet<tbl_User_Audit> tbl_User_Audit { get; set; }
        ...
        public DbSet<tbl_FollowUpCall> tbl_FollowUpCall { get; set; }
        public DbSet<tlkp_FollowUpCallResult> tlkp_FollowUpCallResult { get; set; }
        public DbSet<tlkp_ReasonBowelObstructionOperative> tlkp_ReasonBowelObstructionOperative { get; set; }
        public DbSet<tlkp_DeathRelatedToSurgery> tlkp_DeathRelatedToSurgery { get; set; }
        public DbSet<tbl_Patient> tbl_Patient { get; set; }
        public DbSet<tbl_Patient_Audit> tbl_Patient_Audit { get; set; }
        public DbSet<tbl_UserFavouriteDeviceDetails> tbl_UserFavouriteDeviceDetails { get; set; }
        public DbSet<tlkp_ButtressType> tlkp_ButtressType { get; set; }
        public DbSet<tbl_UserFavouriteDeviceDetails_Audit> tbl_UserFavouriteDeviceDetails_Audit { get; set; }
        ...
        public virtual int CreateEmailForFollowUp()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CreateEmailForFollowUp");
        }
    
        [EdmFunction("BusinessEntities", "ufn_Matching_Patient_List")]
        public virtual IQueryable<ufn_Matching_Patient_List_Result> ufn_Matching_Patient_List()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufn_Matching_Patient_List_Result>("[BusinessEntities].[ufn_Matching_Patient_List]()");
        }
    
        public virtual ObjectResult<sp_Report_RevisionSurgerySummaryReport_Result> sp_Report_RevisionSurgerySummaryReport(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
    
            var pSurgeonIdParameter = pSurgeonId.HasValue ?
                new ObjectParameter("pSurgeonId", pSurgeonId) :
                new ObjectParameter("pSurgeonId", typeof(int));
    
            var pOpDateFromParameter = pOpDateFrom.HasValue ?
                new ObjectParameter("pOpDateFrom", pOpDateFrom) :
                new ObjectParameter("pOpDateFrom", typeof(System.DateTime));
    
            var pOpDateToParameter = pOpDateTo.HasValue ?
                new ObjectParameter("pOpDateTo", pOpDateTo) :
                new ObjectParameter("pOpDateTo", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Report_RevisionSurgerySummaryReport_Result>("sp_Report_RevisionSurgerySummaryReport", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        [EdmFunction("BusinessEntities", "ufn_FollowUp_WorkList")]
        public virtual IQueryable<ufn_FollowUp_WorkList_Result1> ufn_FollowUp_WorkList(Nullable<int> pSurgeonId, Nullable<int> pSiteId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> patID, Nullable<int> opVal)
        {
            var pSurgeonIdParameter = pSurgeonId.HasValue ?
                new ObjectParameter("pSurgeonId", pSurgeonId) :
                new ObjectParameter("pSurgeonId", typeof(int));
            ...
            var opValParameter = opVal.HasValue ?
                new ObjectParameter("OpVal", opVal) :
                new ObjectParameter("OpVal", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufn_FollowUp_WorkList_Result1>("[BusinessEntities].[ufn_FollowUp_WorkList](@pSurgeonId, @pSiteId, @pOpDateFrom, @pOpDateTo, @PatID, @OpVal)", pSurgeonIdParameter, pSiteIdParameter, pOpDateFromParameter, pOpDateToParameter, patIDParameter, opValParameter);
        }
    
        public virtual ObjectResult<usp_CreateFollowUps_Result> usp_CreateFollowUps()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_CreateFollowUps_Result>("usp_CreateFollowUps");
        }
    
        public virtual ObjectResult<usp_BenchMarkingReport_Result> usp_BenchMarkingReport(Nullable<int> pStateId, Nullable<int> pCountryId, Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<int> pOpTypeID, Nullable<int> pRunForLegacyOnly)
        {
            var pStateIdParameter = pStateId.HasValue ?
                new ObjectParameter("pStateId", pStateId) :
                new ObjectParameter("pStateId", typeof(int));
    
            var pCountryIdParameter = pCountryId.HasValue ?
                new ObjectParameter("pCountryId", pCountryId) :
                new ObjectParameter("pCountryId", typeof(int));
            ...
            var pOpTypeIDParameter = pOpTypeID.HasValue ?
                new ObjectParameter("pOpTypeID", pOpTypeID) :
                new ObjectParameter("pOpTypeID", typeof(int));
    
            var pRunForLegacyOnlyParameter = pRunForLegacyOnly.HasValue ?
                new ObjectParameter("pRunForLegacyOnly", pRunForLegacyOnly) :
                new ObjectParameter("pRunForLegacyOnly", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_BenchMarkingReport_Result>("usp_BenchMarkingReport", pStateIdParameter, pCountryIdParameter, pSiteIdParameter, pSurgeonIdParameter, pOpTypeIDParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_ConsentReport_Result> usp_ConsentReport(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOptOffdateFrom, Nullable<System.DateTime> pOptOffdateto, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            var pOptOffdateFromParameter = pOptOffdateFrom.HasValue ?
                new ObjectParameter("pOptOffdateFrom", pOptOffdateFrom) :
                new ObjectParameter("pOptOffdateFrom", typeof(System.DateTime));
    
            var pOptOffdatetoParameter = pOptOffdateto.HasValue ?
                new ObjectParameter("pOptOffdateto", pOptOffdateto) :
                new ObjectParameter("pOptOffdateto", typeof(System.DateTime));
    
            var pRunForLegacyOnlyParameter = pRunForLegacyOnly.HasValue ?
                new ObjectParameter("pRunForLegacyOnly", pRunForLegacyOnly) :
                new ObjectParameter("pRunForLegacyOnly", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_ConsentReport_Result>("usp_ConsentReport", pSiteIdParameter, pSurgeonIdParameter, pOptOffdateFromParameter, pOptOffdatetoParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_Report_RevisionSurgerySummaryReport_Result> usp_Report_RevisionSurgerySummaryReport(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_Report_RevisionSurgerySummaryReport_Result>("usp_Report_RevisionSurgerySummaryReport", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        public virtual ObjectResult<usp_Report_RevSurgSumm_ReOp_Result> usp_Report_RevSurgSumm_ReOp(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_Report_RevSurgSumm_ReOp_Result>("usp_Report_RevSurgSumm_ReOp", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonReport_SentinelEveCnt_Result> usp_SurgeonReport_SentinelEveCnt(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonReport_SentinelEveCnt_Result>("usp_SurgeonReport_SentinelEveCnt", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_DiaxCnt_Result> usp_SurgeonRpt_DiaxCnt(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_DiaxCnt_Result>("usp_SurgeonRpt_DiaxCnt", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_FollowUpCnt_Result> usp_SurgeonRpt_FollowUpCnt(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_FollowUpCnt_Result>("usp_SurgeonRpt_FollowUpCnt", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_OpProcAndOpCnt_Result> usp_SurgeonRpt_OpProcAndOpCnt(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_OpProcAndOpCnt_Result>("usp_SurgeonRpt_OpProcAndOpCnt", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_PatCnt_Result> usp_SurgeonRpt_PatCnt(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_PatCnt_Result>("usp_SurgeonRpt_PatCnt", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_SelfReportedWtCnt_Result> usp_SurgeonRpt_SelfReportedWtCnt(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_SelfReportedWtCnt_Result>("usp_SurgeonRpt_SelfReportedWtCnt", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual int usp_BenchMarkingComparison(Nullable<int> pStateId_A, Nullable<int> pCountryId_A, Nullable<int> pSiteId_A, Nullable<int> pSurgeonId_A, Nullable<int> pOpTypeID_A, Nullable<int> pStateId_B, Nullable<int> pCountryId_B, Nullable<int> pSiteId_B, Nullable<int> pSurgeonId_B, Nullable<int> pOpTypeID_B, Nullable<int> pRunForLegacyOnly_A, Nullable<int> pRunForLegacyOnly_B)
        {
            var pStateId_AParameter = pStateId_A.HasValue ?
                new ObjectParameter("pStateId_A", pStateId_A) :
                new ObjectParameter("pStateId_A", typeof(int));
    
            var pCountryId_AParameter = pCountryId_A.HasValue ?
                new ObjectParameter("pCountryId_A", pCountryId_A) :
                new ObjectParameter("pCountryId_A", typeof(int));
    
            var pSiteId_AParameter = pSiteId_A.HasValue ?
                new ObjectParameter("pSiteId_A", pSiteId_A) :
                new ObjectParameter("pSiteId_A", typeof(int));
    
            var pSurgeonId_AParameter = pSurgeonId_A.HasValue ?
                new ObjectParameter("pSurgeonId_A", pSurgeonId_A) :
                new ObjectParameter("pSurgeonId_A", typeof(int));
    
            var pOpTypeID_AParameter = pOpTypeID_A.HasValue ?
                new ObjectParameter("pOpTypeID_A", pOpTypeID_A) :
                new ObjectParameter("pOpTypeID_A", typeof(int));
    
            var pStateId_BParameter = pStateId_B.HasValue ?
                new ObjectParameter("pStateId_B", pStateId_B) :
                new ObjectParameter("pStateId_B", typeof(int));
    
            var pCountryId_BParameter = pCountryId_B.HasValue ?
                new ObjectParameter("pCountryId_B", pCountryId_B) :
                new ObjectParameter("pCountryId_B", typeof(int));
    
            var pSiteId_BParameter = pSiteId_B.HasValue ?
                new ObjectParameter("pSiteId_B", pSiteId_B) :
                new ObjectParameter("pSiteId_B", typeof(int));
    
            var pSurgeonId_BParameter = pSurgeonId_B.HasValue ?
                new ObjectParameter("pSurgeonId_B", pSurgeonId_B) :
                new ObjectParameter("pSurgeonId_B", typeof(int));
    
            var pOpTypeID_BParameter = pOpTypeID_B.HasValue ?
                new ObjectParameter("pOpTypeID_B", pOpTypeID_B) :
                new ObjectParameter("pOpTypeID_B", typeof(int));
    
            var pRunForLegacyOnly_AParameter = pRunForLegacyOnly_A.HasValue ?
                new ObjectParameter("pRunForLegacyOnly_A", pRunForLegacyOnly_A) :
                new ObjectParameter("pRunForLegacyOnly_A", typeof(int));
    
            var pRunForLegacyOnly_BParameter = pRunForLegacyOnly_B.HasValue ?
                new ObjectParameter("pRunForLegacyOnly_B", pRunForLegacyOnly_B) :
                new ObjectParameter("pRunForLegacyOnly_B", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_BenchMarkingComparison", pStateId_AParameter, pCountryId_AParameter, pSiteId_AParameter, pSurgeonId_AParameter, pOpTypeID_AParameter, pStateId_BParameter, pCountryId_BParameter, pSiteId_BParameter, pSurgeonId_BParameter, pOpTypeID_BParameter, pRunForLegacyOnly_AParameter, pRunForLegacyOnly_BParameter);
        }
    
        public virtual ObjectResult<usp_CreateFollowUpsAlerts_Result> usp_CreateFollowUpsAlerts()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_CreateFollowUpsAlerts_Result>("usp_CreateFollowUpsAlerts");
        }
    
        public virtual int usp_UpdatePatientOptoffSts()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_UpdatePatientOptoffSts");
        }
    
        public virtual int usp_ValidateFollowUpsForPatID(Nullable<int> pPatID, string pReason)
        {
            var pPatIDParameter = pPatID.HasValue ?
                new ObjectParameter("pPatID", pPatID) :
                new ObjectParameter("pPatID", typeof(int));
    
            var pReasonParameter = pReason != null ?
                new ObjectParameter("pReason", pReason) :
                new ObjectParameter("pReason", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_ValidateFollowUpsForPatID", pPatIDParameter, pReasonParameter);
        }
        ...
        public virtual int usp_CheckTableColumnTypes2(string pSourceTable, string pDestTable, string pState)
        {
            var pSourceTableParameter = pSourceTable != null ?
                new ObjectParameter("pSourceTable", pSourceTable) :
                new ObjectParameter("pSourceTable", typeof(string));
    
            var pDestTableParameter = pDestTable != null ?
                new ObjectParameter("pDestTable", pDestTable) :
                new ObjectParameter("pDestTable", typeof(string));
    
            var pStateParameter = pState != null ?
                new ObjectParameter("pState", pState) :
                new ObjectParameter("pState", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_CheckTableColumnTypes2", pSourceTableParameter, pDestTableParameter, pStateParameter);
        }
    
        public virtual int usp_DeleteOperation(Nullable<int> patientID, Nullable<int> operationID)
        {
            var patientIDParameter = patientID.HasValue ?
                new ObjectParameter("PatientID", patientID) :
                new ObjectParameter("PatientID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_DeleteOperation", patientIDParameter, operationIDParameter);
        }
    
        public virtual ObjectResult<usp_RSSR_ReasonsForPort_ReOP_Result> usp_RSSR_ReasonsForPort_ReOP(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_RSSR_ReasonsForPort_ReOP_Result>("usp_RSSR_ReasonsForPort_ReOP", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        public virtual ObjectResult<usp_RSSR_ReasonsForSlip_ReOP_Result> usp_RSSR_ReasonsForSlip_ReOP(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_RSSR_ReasonsForSlip_ReOP_Result>("usp_RSSR_ReasonsForSlip_ReOP", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        public virtual ObjectResult<usp_RSSR_ReOpReason_Result> usp_RSSR_ReOpReason(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_RSSR_ReOpReason_Result>("usp_RSSR_ReOpReason", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonReport_SentinelEveCnt1_Result> usp_SurgeonReport_SentinelEveCnt1(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonReport_SentinelEveCnt1_Result>("usp_SurgeonReport_SentinelEveCnt1", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_DiaxCnt2_Result> usp_SurgeonRpt_DiaxCnt2(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_DiaxCnt2_Result>("usp_SurgeonRpt_DiaxCnt2", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_DiaxCnt3_Result> usp_SurgeonRpt_DiaxCnt3(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_DiaxCnt3_Result>("usp_SurgeonRpt_DiaxCnt3", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_Reasons_Result> usp_SurgeonRpt_Reasons(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pIsForSE, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            var pIsForSEParameter = pIsForSE.HasValue ?
                new ObjectParameter("pIsForSE", pIsForSE) :
                new ObjectParameter("pIsForSE", typeof(int));
    
            var pRunForLegacyOnlyParameter = pRunForLegacyOnly.HasValue ?
                new ObjectParameter("pRunForLegacyOnly", pRunForLegacyOnly) :
                new ObjectParameter("pRunForLegacyOnly", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_Reasons_Result>("usp_SurgeonRpt_Reasons", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pIsForSEParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_ReasonsForPort_Result> usp_SurgeonRpt_ReasonsForPort(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pIsForSE, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_ReasonsForPort_Result>("usp_SurgeonRpt_ReasonsForPort", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pIsForSEParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_ReasonsForPort_SE_Result> usp_SurgeonRpt_ReasonsForPort_SE(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_ReasonsForPort_SE_Result>("usp_SurgeonRpt_ReasonsForPort_SE", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_ReasonsForSlip_Result> usp_SurgeonRpt_ReasonsForSlip(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pIsForSE, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_ReasonsForSlip_Result>("usp_SurgeonRpt_ReasonsForSlip", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pIsForSEParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_ReasonsForSlip_SE_Result> usp_SurgeonRpt_ReasonsForSlip_SE(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_ReasonsForSlip_SE_Result>("usp_SurgeonRpt_ReasonsForSlip_SE", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_ReOpReason_Result> usp_SurgeonRpt_ReOpReason(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_ReOpReason_Result>("usp_SurgeonRpt_ReOpReason", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        public virtual ObjectResult<usp_SurgeonRpt_SentinelEveReason_Result> usp_SurgeonRpt_SentinelEveReason(Nullable<int> pSiteId, Nullable<int> pSurgeonId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo, Nullable<int> pRunForLegacyOnly)
        {
            var pSiteIdParameter = pSiteId.HasValue ?
                new ObjectParameter("pSiteId", pSiteId) :
                new ObjectParameter("pSiteId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SurgeonRpt_SentinelEveReason_Result>("usp_SurgeonRpt_SentinelEveReason", pSiteIdParameter, pSurgeonIdParameter, pOpDateFromParameter, pOpDateToParameter, pRunForLegacyOnlyParameter);
        }
    
        [EdmFunction("BusinessEntities", "ufn_Missing_DataList")]
        public virtual IQueryable<ufn_Missing_DataList_Result1> ufn_Missing_DataList(Nullable<int> pCountryId, Nullable<int> pOpStat, Nullable<int> pSurgeonId, Nullable<int> pSiteId, Nullable<System.DateTime> pOpDateFrom, Nullable<System.DateTime> pOpDateTo)
        {
            var pCountryIdParameter = pCountryId.HasValue ?
                new ObjectParameter("pCountryId", pCountryId) :
                new ObjectParameter("pCountryId", typeof(int));
    
            var pOpStatParameter = pOpStat.HasValue ?
                new ObjectParameter("pOpStat", pOpStat) :
                new ObjectParameter("pOpStat", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufn_Missing_DataList_Result1>("[BusinessEntities].[ufn_Missing_DataList](@pCountryId, @pOpStat, @pSurgeonId, @pSiteId, @pOpDateFrom, @pOpDateTo)", pCountryIdParameter, pOpStatParameter, pSurgeonIdParameter, pSiteIdParameter, pOpDateFromParameter, pOpDateToParameter);
        }
    
        public virtual int usp_UpdateFollowUpsAsInvalidOrValid(Nullable<int> pOpId)
        {
            var pOpIdParameter = pOpId.HasValue ?
                new ObjectParameter("pOpId", pOpId) :
                new ObjectParameter("pOpId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_UpdateFollowUpsAsInvalidOrValid", pOpIdParameter);
        }
    
        public virtual int usp_CreateOpFollowUp(Nullable<int> pOpId, Nullable<int> patient)
        {
            var pOpIdParameter = pOpId.HasValue ?
                new ObjectParameter("pOpId", pOpId) :
                new ObjectParameter("pOpId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_CreateOpFollowUp", pOpIdParameter, patientParameter);
        }
    
        [EdmFunction("BusinessEntities", "ufn_Patient_CallWorkList")]
        public virtual IQueryable<ufn_Patient_CallWorkList_Result> ufn_Patient_CallWorkList(Nullable<int> countryId, Nullable<int> stateId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufn_Patient_CallWorkList_Result>("[BusinessEntities].[ufn_Patient_CallWorkList](@countryId, @stateId)", countryIdParameter, stateIdParameter);
        }
    
        [EdmFunction("BusinessEntities", "ufn_Matching_Patients")]
        public virtual IQueryable<ufn_Matching_Patients_Result> ufn_Matching_Patients(Nullable<int> row_Cnt)
        {
            var row_CntParameter = row_Cnt.HasValue ?
                new ObjectParameter("Row_Cnt", row_Cnt) :
                new ObjectParameter("Row_Cnt", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufn_Matching_Patients_Result>("[BusinessEntities].[ufn_Matching_Patients](@Row_Cnt)", row_CntParameter);
        }
    
        public virtual ObjectResult<usp_Patient_CallWorkList_Result> usp_Patient_CallWorkList(Nullable<int> countryId, Nullable<int> stateId)
        {
            var countryIdParameter = countryId.HasValue ?
                new ObjectParameter("countryId", countryId) :
                new ObjectParameter("countryId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_Patient_CallWorkList_Result>("usp_Patient_CallWorkList", countryIdParameter, stateIdParameter);
        }
    }
}
